...
from watch.tasks.rutgers_material_seg.experiments.bigearthnet_finetune import experiment, torch, torch, np, random, torch, print, experiment, experiment, experiment, experiment, experiment, experiment, print, model


def __getattr__(key):
    import watch.tasks.rutgers_material_seg.experiments.bigearthnet_finetune as mirror
