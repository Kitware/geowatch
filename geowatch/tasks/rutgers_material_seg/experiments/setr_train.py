...
from watch.tasks.rutgers_material_seg.experiments.setr_train import experiment, torch, torch, np, random, torch, experiment, experiment, experiment, experiment, experiment, experiment, print, print, print, model


def __getattr__(key):
    import watch.tasks.rutgers_material_seg.experiments.setr_train as mirror
