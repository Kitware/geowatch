...
from watch.tasks.rutgers_material_seg.experiments.onera_patch_train import experiment, torch, torch, np, random, torch, print, experiment, experiment, experiment, experiment, experiment, experiment, print, model


def __getattr__(key):
    import watch.tasks.rutgers_material_seg.experiments.onera_patch_train as mirror
