...
from watch.tasks.rutgers_material_seg.experiments.onera_patch_finetune2 import experiment, torch, torch, np, random, torch, experiment, experiment, experiment, experiment, experiment, experiment, print, model


def __getattr__(key):
    import watch.tasks.rutgers_material_seg.experiments.onera_patch_finetune2 as mirror
