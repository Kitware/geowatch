...
watch-cli watch_coco_stats $HOME/data/dvc-repos/smart_watch_dvc/drop1-S2-L8-aligned-old/data_gsd10.kwcoco.json

kwcoco subset --src $HOME/data/dvc-repos/smart_watch_dvc/drop1-S2-L8-aligned-old/data_gsd10.kwcoco.json \
        --dst $HOME/data/dvc-repos/smart_watch_dvc/drop1-S2-L8-aligned-old/data_gsd10_vali.kwcoco.json \
        --select_videos '.name | startswith("KR_")'

kwcoco subset --src $HOME/data/dvc-repos/smart_watch_dvc/drop1-S2-L8-aligned-old/data_gsd10.kwcoco.json \
        --dst $HOME/data/dvc-repos/smart_watch_dvc/drop1-S2-L8-aligned-old/data_gsd10_train.kwcoco.json \
        --select_videos '.name | startswith("KR_") | not'

kwcoco stats \
    $HOME/data/dvc-repos/smart_watch_dvc/drop1-S2-L8-aligned-old/data_gsd10_train.kwcoco.json \
    $HOME/data/dvc-repos/smart_watch_dvc/drop1-S2-L8-aligned-old/data_gsd10_vali.kwcoco.json
