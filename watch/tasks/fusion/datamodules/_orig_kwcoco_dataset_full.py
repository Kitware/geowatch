...
class KWCocoVideoDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        CommandLine:
            DVC_DPATH=$(smartwatch_dvc --hardware="hdd") xdoctest -m watch.tasks.fusion.datamodules.kwcoco_dataset KWCocoVideoDataset.__getitem__:0 --profile
        ...
        if 1:
            print(f'vidspace_gsd={vidspace_gsd}')
            print(f'sample_scale={sample_scale}')
            print(f'space_scale={space_scale}')
    ...
    def compute_dataset_stats(self, num=None, num_workers=0, batch_size=2,
        ...
        CommandLine:
            DVC_DPATH=$HOME/data/dvc-repos/smart_watch_dvc xdoctest -m watch.tasks.fusion.datamodules.kwcoco_dataset KWCocoVideoDataset.compute_dataset_stats:1
