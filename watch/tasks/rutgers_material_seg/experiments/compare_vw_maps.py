...
from geowatch.tasks.rutgers_material_seg.experiments.compare_vw_maps import experiment, torch, torch, np, random, torch, experiment, experiment, experiment, experiment, experiment, experiment, print, ours_model, resnet_model, ours_model


def __getattr__(key):
    import geowatch.tasks.rutgers_material_seg.experiments.compare_vw_maps as mirror
