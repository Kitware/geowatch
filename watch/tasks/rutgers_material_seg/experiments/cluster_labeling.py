...
from geowatch.tasks.rutgers_material_seg.experiments.cluster_labeling import print, dset, sys


def __getattr__(key):
    import geowatch.tasks.rutgers_material_seg.experiments.cluster_labeling as mirror
