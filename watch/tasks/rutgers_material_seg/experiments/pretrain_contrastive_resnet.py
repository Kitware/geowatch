...
from geowatch.tasks.rutgers_material_seg.experiments.pretrain_contrastive_resnet import experiment, torch, torch, np, random, torch, experiment, experiment, experiment, experiment, experiment, experiment, print, model


def __getattr__(key):
    import geowatch.tasks.rutgers_material_seg.experiments.pretrain_contrastive_resnet as mirror
