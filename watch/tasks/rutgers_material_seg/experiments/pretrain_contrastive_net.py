...
from geowatch.tasks.rutgers_material_seg.experiments.pretrain_contrastive_net import experiment, torch, torch, np, random, torch, experiment, experiment, experiment, experiment, experiment, experiment, print, model


def __getattr__(key):
    import geowatch.tasks.rutgers_material_seg.experiments.pretrain_contrastive_net as mirror
