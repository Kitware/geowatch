...
from geowatch.tasks.rutgers_material_seg.experiments.dynamicearthnet_finetune import experiment, torch, torch, np, random, torch, print, experiment, experiment, experiment, experiment, experiment, experiment, print, model


def __getattr__(key):
    import geowatch.tasks.rutgers_material_seg.experiments.dynamicearthnet_finetune as mirror
