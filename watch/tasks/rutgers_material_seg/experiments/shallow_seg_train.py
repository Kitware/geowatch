...
from geowatch.tasks.rutgers_material_seg.experiments.shallow_seg_train import experiment, torch, torch, np, random, torch, experiment, experiment, experiment, experiment, experiment, experiment, print, print, print, model


def __getattr__(key):
    import geowatch.tasks.rutgers_material_seg.experiments.shallow_seg_train as mirror
