...
def main():
    ...
    parser.add_argument("-i", "--iou-threshold",
                        ...
                        help="IOU Threshold for determining duplicates"
                             "(default: 0.5)")
    parser.add_argument(
        'ta2_collated_dir_previous', type=str,
        help="Path to TA2 collated output dir for previous iteration")
    parser.add_argument(
        'ta2_collated_dir_current', type=str,
        help="Path to TA2 collated output dir for current iteration")
...
def run_pseudolive_consolidate(region_id,
    ...
    for _, psid, csid in sorted_overlaps:
