...
RUTGERS_MODEL_FPATH="$DVC_DPATH/models/rutgers/experiments_epoch_30_loss_0.05691597167379317_valmIoU_0.5694727912477856_time_2021-08-07-09:01:01.pth"
...
RUTGERS_MODEL_FPATH        = $RUTGERS_MODEL_FPATH
...
# TODO: generate landcover features

# TODO: generate rutgers features


# Combine TA2 Team Features into a single file
python ~/code/watch/watch/cli/coco_combine_features.py \
    --src $BASE_COCO_FPATH $UKY_INVARIANTS_COCO_FPATH $DZYNE_LANDCOVER_COCO_FPATH \
