...
Notes:
    ...
    sphinx-apidoc -f -o ~/code/geowatch/docs/source ~/code/geowatch/geowatch --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/geowatch/advanced/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/geowatch/versions/
"""
#
...
# html_favicon = '.static/geowatch.ico'
...
man_pages = [
    (master_doc, 'geowatch', 'geowatch Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'geowatch', 'geowatch Documentation',
     author, 'geowatch', 'One line description of project.',
     'Miscellaneous'),
]
